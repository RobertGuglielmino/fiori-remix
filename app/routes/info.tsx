    ...
    return (
        <div className="center m-10">
            <div className="text-center font-quicksand text-xl">
                ...
                If you enjoy clicking around on here every once in a while, consider donating to me on <a className="text-blue-500 underline" target="_blank" href="https://ko-fi.com/robertguglielmino">Ko-Fi.</a><br /><br />
