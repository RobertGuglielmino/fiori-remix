  ...
  return (<div className="">
    ...
    <div className="center m-10">
      <div className="text-center font-quicksand">
        ...
        <br /><br />Choose a <b> Magic Set</b> and <b>Booster Type</b>, then click GO!<br /><br />
        <b>Flip It Or Rip It</b> is played by opening a pack of trading cards, placing them face down, alternating between <b>Flip</b>ping a card face up (where you keep the card) and <b>Rip</b>ping a card, so that it is destroyed forever.<br /><br />
        Engaging in this activity with real cards is exhilarating, and disgusting.<br /><br /> This website lets you simulate that experience.<br /><br />
      </div>
    </div>
    <div className="flex flex-row justify-center gap-2">
      <button onClick={() => navigate("/stats")} className="bg-amber-500 hover:bg-amber-400 active:bg-amber-600  font-quicksand p-12 rounded">
      ...
      <button onClick={() => navigate("/info")} className="bg-red-500 hover:bg-red-400 active:bg-red-600 font-quicksand p-12 rounded">
        <div className='object-center flex flex-col items-center justify-center'>
      ...
      <button onClick={() => navigate("/settings")} className="bg-slate-400 hover:bg-slate-300 active:bg-slate-500 font-quicksand p-12 rounded">
        <div className='object-center flex flex-col items-center justify-center'>
