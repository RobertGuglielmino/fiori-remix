  ...
  return (<div className="">
    ...
    <div className="center m-10">
      <div className="text-center font-quicksand">
        ...
        <b>Flip It Or Rip It</b> is played by opening a pack of trading cards, placing them face down, alternating between <b>Flip</b>ping a card face up to keep it, and <b>Rip</b>ping a card, destroying it forever.<br /><br />
