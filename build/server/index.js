...
const stylesheet = "/assets/tailwind-BfRCh3Vu.css";
...
function FlipRipDisplay() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row w-full md:gap-2 h-100 overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "w-full md:w-auto flex justify-center", children: /* @__PURE__ */ jsx("img", { fetchPriority: "high", className: `${toFlip ? "opacity-100" : "opacity-25"} h-25 w-auto object-contain transition duration-150`, src: FIORI_FLIP_IMAGE, alt: "" }) }),
    /* @__PURE__ */ jsx("div", { className: "w-full md:w-auto flex justify-center", children: /* @__PURE__ */ jsx("img", { fetchPriority: "high", className: `${toRip ? "opacity-100" : "opacity-25"} h-25 w-auto object-contain transition duration-150`, src: FIORI_RIP_IMAGE, alt: "" }) })
  ] }) });
}
...
function HeaderContainer({ changeValue }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxs("div", { className: "place-content-evenly flex items-center flex-row gap-2 sm:gap-6 m-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("ol", { className: "text-3xl w-3/4 md:w-1/2 text-left list-none", children: [
        ...
        /* @__PURE__ */ jsxs("li", { className: "mb-2", children: [
          ...
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-green-600 font-bold drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]", children: "FLIP" }),
          " a card face up and ",
        ...
        /* @__PURE__ */ jsxs("li", { className: "mb-2", children: [
          ...
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-red-800 font-bold drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]", children: "RIP" }),
          " a card and ",
...
async function loader$1() {
  ...
  const response = await fetch("https://d3vjinhen5j20w.cloudfront.net/PACK_TYPES_BY_SET.json").then(async (res) => {
    const data = await res.json();
    return data;
  });
  invariant(response, "Missing data from scryfall");
  const duration = performance.now() - start_perf;
  console.log(`seconds elapsed = ${Math.floor(Date.now() - start / 1e3)}`);
  return json$1(
    {
      apiData: response
    },
...
function Index() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-stone-200", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-2 pb-4", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          disabled: true,
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xl font-quicksand", children: "STATS" }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-quicksand", children: "(soon!)" })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xl font-quicksand", children: "INFO" })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xl font-quicksand", children: "SETTINGS" })
          ]
        }
      )
    ] })
...
function EnhancedCard({ alt, handleCardClick }) {
