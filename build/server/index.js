...
function CardContainer({ name, cents, image, status, foil, rotation, maskImage, handleCardClick }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center rounded-lg", children: [
    ...
    status === "FLIPPED" && /* @__PURE__ */ jsx(FlippedCard, { src: image, alt: "test", foil }),
    status === "RIPPED" && /* @__PURE__ */ jsx(RippedCard, { src: image, maskImage, maskPosition }),
